// To parse this data:
//
//   import { Convert, ProductsDetails } from "./file";
//
//   const productsDetails = Convert.toProductsDetails(json);
//
...
export class Convert {
    public static toProductsDetails(json: string): ProductsDetails {
        return cast(JSON.parse(json), r("ProductsDetails"));
    }

    public static productsDetailsToJson(value: ProductsDetails): string {
        return JSON.stringify(uncast(value, r("ProductsDetails")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Data": o([
        ...
        { json: "reviews", js: "reviews", typ: a("any") },
        { json: "id", js: "id", typ: "" },
    ], false),
    "Brand": o([
        { json: "_id", js: "_id", typ: "" },
